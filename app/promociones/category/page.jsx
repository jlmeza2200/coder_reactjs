...
const Promociones = () => {
  ...
  const productsPromo = products.slice(3, 7);

  return (
    <>
      <Header image="/image2.jpeg" title1="-- Don't Miss Out" title2="Special Discounts" title3="Discover More" />
      <div className="px-3 md:px-10 lg:px-10 xl:px-20 pt-28 bg-white text-black md:text-left grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
        {productsPromo.map((prod) => (
          <div key={prod.id} className="p-4">
            ...
            <div className="pt-3">
              <h6 className="font-medium md:text-left pb-3">{prod.title}</h6>
              <div>
